...
void Player::view_skills(){
	...
	}if (sk_list[3] != 0)
	{
		...
		cout << "¸ô¾ÆÄ¡±â Lv1";
		gotoxy(x + 8, y + 2 + i);
		cout << "µ¥¹ÌÁö: ÀÏ¹Ý°ø°Ý·Â X 1.5   ¼Ò¸ðap:  10";
		i += 2;
	}if (sk_list[4] != 0)
	{
		gotoxy(x + 3, y + 1 + i);
		cout << "¸ô¾ÆÄ¡±â Lv2";
		gotoxy(x + 8, y + 2 + i);
		cout << "µ¥¹ÌÁö: ÀÏ¹Ý°ø°Ý·Â X 1.5   ¼Ò¸ðap:  50";
		i += 2;
	}if (sk_list[5] != 0)
	{
		gotoxy(x + 3, y + 1 + i);
		cout << "¸ô¾ÆÄ¡±â Lv3";
		gotoxy(x + 8, y + 2 + i);
		cout << "µ¥¹ÌÁö: ÀÏ¹Ý°ø°Ý·Â X 1.5   ¼Ò¸ðap: 120";
		i += 2;
	}if (sk_list[6] != 0)
	{
		gotoxy(x + 3, y + 1 + i);
